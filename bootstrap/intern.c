...
void intern_preload(void) {
    static const char* specials[] = {
        "quote",                     /* SYM_ID_QUOTE = 0: ⌜ */
        "quasiquote-tilde",             /* SYM_ID_QUASIQUOTE = 1: ⌞̃ */
        "macro-rules",         /* SYM_ID_MACRO_RULES = 2: ⧉⊜ */
        "macro",                     /* SYM_ID_MACRO = 3: ⧉ */
        "define",                     /* SYM_ID_DEFINE = 4: ≔ */
        "type-decl",                     /* SYM_ID_TYPE_DECL = 5: ∈ */
        "type-check",                    /* SYM_ID_TYPE_CHECK = 6: ∈? */
        "type-validate",         /* SYM_ID_TYPE_VALIDATE = 7: ∈✓ */
        "type-infer",         /* SYM_ID_TYPE_INFER = 8: ∈⍜ */
        "type-assert",         /* SYM_ID_TYPE_ASSERT = 9: ∈⊢ */
        "type-infer-all",        /* SYM_ID_TYPE_INFER_ALL = 10: ∈⍜* */
        ":lambda-converted",              /* SYM_ID_LAMBDA_CONV = 11: :λ-converted */
        "lambda",                         /* SYM_ID_LAMBDA = 12: λ */
        "if",                                /* SYM_ID_IF = 13 */
        "begin",                     /* SYM_ID_SEQUENCE = 14: ⪢ */
        "match",                     /* SYM_ID_RECUR = 15: ∇ */
        "effect-def",                     /* SYM_ID_EFFECT_DEF = 16: ⟪ */
        "effect?",                    /* SYM_ID_EFFECT_Q = 17: ⟪? */
        "effect-get",         /* SYM_ID_EFFECT_GET = 18: ⟪→ */
        "handle",         /* SYM_ID_HANDLE = 19: ⟪⟫ */
        "handle-resume", /* SYM_ID_RESUME = 20: ⟪↺⟫ */
        "perform",                     /* SYM_ID_PERFORM = 21: ↯ */
        "handle-linear", /* SYM_ID_COMPOSE = 22: ⟪⊸⟫ */
        "consume",                     /* SYM_ID_PIPE = 23: ⊸ */
        ...
        "and",                     /* SYM_ID_AND = 28: ∧ */
        "or",                     /* SYM_ID_OR = 29: ∨ */
        "try",                    /* SYM_ID_TRY_PROP = 30: ⚡? */
        "refine-def",         /* SYM_ID_REFINE_DEF = 31: ∈⊡ */
        "generic-param",                     /* SYM_ID_GENERIC_PARAM = 32: ⊳ */
        "bind",                     /* SYM_ID_BIND = 33: ≫ */
    };
